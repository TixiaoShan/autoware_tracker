...
VisualizeRects::VisualizeRects()
{
  ...
  detection_filter_subscriber_ = new message_filters::Subscriber<autoware_tracker::DetectedObjectArray>(private_nh_,
                                                                                                     object_src_topic,
                                                                                             1);
...
VisualizeRects::SyncedDetectionsCallback(
  ...
  const autoware_tracker::DetectedObjectArray::ConstPtr &in_objects)
{
  try
  {
...
cv::Mat
VisualizeRects::ObjectsToRects(cv::Mat in_image, const autoware_tracker::DetectedObjectArray::ConstPtr &in_objects)
{
...
bool VisualizeRects::IsObjectValid(const autoware_tracker::DetectedObject &in_object)
{
  if (!in_object.valid ||
      in_object.width < 0 ||
      in_object.height < 0 ||
