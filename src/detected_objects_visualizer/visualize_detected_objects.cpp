...
VisualizeDetectedObjects::ObjectsToCentroids(const autoware_tracker::DetectedObjectArray &in_objects)
{
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToBoxes(const autoware_tracker::DetectedObjectArray &in_objects)
{
