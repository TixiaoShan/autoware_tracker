...
public:
  ...
  bool is_stable_;
  autoware_tracker::DetectedObject object_;
  std::string label_;
  ...
  void updateMeasurementForCTRV(const std::vector<autoware_tracker::DetectedObject>& object_vec);

  void uppateForCTRV();

  void updateEachMotion(const double detection_probability, const double gate_probability, const double gating_thres,
                        const std::vector<autoware_tracker::DetectedObject>& object_vec, std::vector<double>& lambda_vec);

  void updateSUKF(const std::vector<autoware_tracker::DetectedObject>& object_vec);
  ...
  void checkLaneDirectionAvailability(const autoware_tracker::DetectedObject& in_object,
  ...
  double calculateNIS(const autoware_tracker::DetectedObject& in_object, const int motion_ind);

  bool isLaneDirectionAvailable(const autoware_tracker::DetectedObject& in_object, const int motion_ind,
  ...
  void update(const bool use_sukf, const double detection_probability, const double gate_probability,
              const double gating_thres, const std::vector<autoware_tracker::DetectedObject>& object_vec);
