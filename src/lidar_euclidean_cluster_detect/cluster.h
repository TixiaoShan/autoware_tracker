...
public:
  ...
  /* \brief Returns the autoware_tracker::CloudCluster message associated to this Cluster */
  void ToROSMessage(std_msgs::Header in_ros_header, autoware_tracker::CloudCluster& out_cluster_message);
