...
void UKF::updateMeasurementForCTRV(const std::vector<autoware_tracker::DetectedObject>& object_vec)
{
...
void UKF::updateSUKF(const std::vector<autoware_tracker::DetectedObject>& object_vec)
{
...
double UKF::calculateNIS(const autoware_tracker::DetectedObject& in_object, const int motion_ind)
{
...
bool UKF::isLaneDirectionAvailable(const autoware_tracker::DetectedObject& in_object, const int motion_ind,
...
void UKF::checkLaneDirectionAvailability(const autoware_tracker::DetectedObject& in_object,
